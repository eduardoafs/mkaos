...
/**
 * This is the item provider adapter for a {@link KAOSModel.Agent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 KAOSModelPackage.Literals.AGENT__PERFORMS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 KAOSModelPackage.Literals.AGENT__COMPOSITION,
				 true,
				 false,
				 true,
				 null,
