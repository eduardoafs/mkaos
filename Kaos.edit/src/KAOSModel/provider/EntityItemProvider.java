...
/**
 * This is the item provider adapter for a {@link KAOSModel.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider extends ObjectItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Entity_composition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Entity_composition_feature", "_UI_Entity_type"),
				 KAOSModelPackage.Literals.ENTITY__COMPOSITION,
				 true,
				 false,
				 true,
				 null,
