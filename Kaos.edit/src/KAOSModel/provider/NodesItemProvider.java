...
/**
 * This is the item provider adapter for a {@link KAOSModel.Nodes} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NodesItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Nodes_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Nodes_name_feature", "_UI_Nodes_type"),
				 KAOSModelPackage.Literals.NODES__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Nodes.class)) {
			case KAOSModelPackage.NODES__NAME:
