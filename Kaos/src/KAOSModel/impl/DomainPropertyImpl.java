 ...
 * </p>
 * <ul>
 *   <li>{@link KAOSModel.impl.DomainPropertyImpl#getUsedIn <em>Used In</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DomainPropertyImpl extends GoalImpl implements DomainProperty {
	...
	protected EClass eStaticClass() {
		return KAOSModelPackage.Literals.DOMAIN_PROPERTY;
	}
	...
	public EList<Refinement> getUsedIn() {
		if (usedIn == null) {
			usedIn = new EObjectResolvingEList<Refinement>(Refinement.class, this, KAOSModelPackage.DOMAIN_PROPERTY__USED_IN);
		}
		return usedIn;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KAOSModelPackage.DOMAIN_PROPERTY__USED_IN:
				return getUsedIn();
		}
