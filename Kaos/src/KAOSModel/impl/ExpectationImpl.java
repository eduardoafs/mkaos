 ...
 * </p>
 * <ul>
 *   <li>{@link KAOSModel.impl.ExpectationImpl#getAssignedTo <em>Assigned To</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExpectationImpl extends GoalImpl implements Expectation {
	...
	protected EClass eStaticClass() {
		return KAOSModelPackage.Literals.EXPECTATION;
	}
	...
	public EList<EnvironmentAgent> getAssignedTo() {
		if (assignedTo == null) {
			assignedTo = new EObjectResolvingEList<EnvironmentAgent>(EnvironmentAgent.class, this, KAOSModelPackage.EXPECTATION__ASSIGNED_TO);
		}
		return assignedTo;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KAOSModelPackage.EXPECTATION__ASSIGNED_TO:
