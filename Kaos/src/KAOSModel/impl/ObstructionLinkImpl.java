 ...
 * </p>
 * <ul>
 *   <li>{@link KAOSModel.impl.ObstructionLinkImpl#getRelateKGoalTo <em>Relate KGoal To</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ObstructionLinkImpl extends LinkImpl implements ObstructionLink {
	...
	protected EClass eStaticClass() {
		return KAOSModelPackage.Literals.OBSTRUCTION_LINK;
	}
	...
	public EList<Obstacle> getRelateKGoalTo() {
		if (relateKGoalTo == null) {
			relateKGoalTo = new EObjectResolvingEList<Obstacle>(Obstacle.class, this, KAOSModelPackage.OBSTRUCTION_LINK__RELATE_KGOAL_TO);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KAOSModelPackage.OBSTRUCTION_LINK__RELATE_KGOAL_TO:
