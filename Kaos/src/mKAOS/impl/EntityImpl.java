 ...
 * </p>
 * <ul>
 *   <li>{@link mKAOS.impl.EntityImpl#getComposition <em>Composition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntityImpl extends ObjectImpl implements Entity {
	...
	protected EClass eStaticClass() {
		return MKAOSPackage.Literals.ENTITY;
	}
	...
	public EList<Entity> getComposition() {
		if (composition == null) {
			composition = new EObjectResolvingEList<Entity>(Entity.class, this, MKAOSPackage.ENTITY__COMPOSITION);
		}
		return composition;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MKAOSPackage.ENTITY__COMPOSITION:
