 ...
 * </p>
 * <ul>
 *   <li>{@link mKAOS.impl.KAOSImpl#getName <em>Name</em>}</li>
 *   <li>{@link mKAOS.impl.KAOSImpl#getLinkedBy <em>Linked By</em>}</li>
 *   <li>{@link mKAOS.impl.KAOSImpl#getConsistsOf <em>Consists Of</em>}</li>
 * </ul>
 *
 * @generated
 */
public class KAOSImpl extends MinimalEObjectImpl.Container implements KAOS {
	...
	protected EClass eStaticClass() {
		return MKAOSPackage.Literals.KAOS;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MKAOSPackage.KAOS__NAME, oldName, name));
	}
	...
	public EList<Link> getLinkedBy() {
		if (linkedBy == null) {
			linkedBy = new EObjectContainmentEList<Link>(Link.class, this, MKAOSPackage.KAOS__LINKED_BY);
		}
		return linkedBy;
	}
	...
	public EList<Nodes> getConsistsOf() {
		if (consistsOf == null) {
			consistsOf = new EObjectContainmentEList<Nodes>(Nodes.class, this, MKAOSPackage.KAOS__CONSISTS_OF);
		}
		return consistsOf;
	}
