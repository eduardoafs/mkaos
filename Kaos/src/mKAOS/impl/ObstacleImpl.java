 ...
 * </p>
 * <ul>
 *   <li>{@link mKAOS.impl.ObstacleImpl#getObstruct <em>Obstruct</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ObstacleImpl extends RefinableNodeImpl implements Obstacle {
	...
	protected EClass eStaticClass() {
		return MKAOSPackage.Literals.OBSTACLE;
	}
	...
	public EList<Goal> getObstruct() {
		if (obstruct == null) {
			obstruct = new EObjectResolvingEList<Goal>(Goal.class, this, MKAOSPackage.OBSTACLE__OBSTRUCT);
		}
		return obstruct;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MKAOSPackage.OBSTACLE__OBSTRUCT:
				return getObstruct();
		}
