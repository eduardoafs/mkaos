 ...
 * </p>
 * <ul>
 *   <li>{@link mKAOS.impl.OperacionalizationLinkImpl#getRelateOperationTo <em>Relate Operation To</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperacionalizationLinkImpl extends LinkImpl implements OperacionalizationLink {
	...
	protected EClass eStaticClass() {
		return MKAOSPackage.Literals.OPERACIONALIZATION_LINK;
	}
	...
	public EList<Requirement> getRelateOperationTo() {
		if (relateOperationTo == null) {
			relateOperationTo = new EObjectResolvingEList<Requirement>(Requirement.class, this, MKAOSPackage.OPERACIONALIZATION_LINK__RELATE_OPERATION_TO);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MKAOSPackage.OPERACIONALIZATION_LINK__RELATE_OPERATION_TO:
