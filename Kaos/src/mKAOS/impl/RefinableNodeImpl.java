 ...
 * </p>
 * <ul>
 *   <li>{@link mKAOS.impl.RefinableNodeImpl#getRefinedBy <em>Refined By</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class RefinableNodeImpl extends NodesImpl implements RefinableNode {
	...
	protected EClass eStaticClass() {
		return MKAOSPackage.Literals.REFINABLE_NODE;
	}
	...
	public EList<Refinement> getRefinedBy() {
		if (refinedBy == null) {
			refinedBy = new EObjectResolvingEList<Refinement>(Refinement.class, this, MKAOSPackage.REFINABLE_NODE__REFINED_BY);
		}
		return refinedBy;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MKAOSPackage.REFINABLE_NODE__REFINED_BY:
				return getRefinedBy();
		}
