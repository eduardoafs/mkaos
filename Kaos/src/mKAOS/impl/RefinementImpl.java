 ...
 * </p>
 * <ul>
 *   <li>{@link mKAOS.impl.RefinementImpl#getRefines <em>Refines</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RefinementImpl extends LinkImpl implements Refinement {
	...
	protected EClass eStaticClass() {
		return MKAOSPackage.Literals.REFINEMENT;
	}
		...
		if (refines != null && refines.eIsProxy()) {
			...
			if (refines != oldRefines) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MKAOSPackage.REFINEMENT__REFINES, oldRefines, refines));
			}
		}
		return refines;
	}
	...
	public void setRefines(RefinableNode newRefines) {
		...
		refines = newRefines;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MKAOSPackage.REFINEMENT__REFINES, oldRefines, refines));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MKAOSPackage.REFINEMENT__REFINES:
