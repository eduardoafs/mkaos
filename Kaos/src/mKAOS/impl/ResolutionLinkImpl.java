 ...
 * </p>
 * <ul>
 *   <li>{@link mKAOS.impl.ResolutionLinkImpl#getAssignObstacleTo <em>Assign Obstacle To</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResolutionLinkImpl extends LinkImpl implements ResolutionLink {
	...
	protected EClass eStaticClass() {
		return MKAOSPackage.Literals.RESOLUTION_LINK;
	}
	...
	public EList<Requirement> getAssignObstacleTo() {
		if (assignObstacleTo == null) {
			assignObstacleTo = new EObjectResolvingEList<Requirement>(Requirement.class, this, MKAOSPackage.RESOLUTION_LINK__ASSIGN_OBSTACLE_TO);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MKAOSPackage.RESOLUTION_LINK__ASSIGN_OBSTACLE_TO:
