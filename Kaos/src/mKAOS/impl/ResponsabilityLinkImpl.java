 ...
 * </p>
 * <ul>
 *   <li>{@link mKAOS.impl.ResponsabilityLinkImpl#getAssignAgentTo <em>Assign Agent To</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResponsabilityLinkImpl extends LinkImpl implements ResponsabilityLink {
	...
	protected EClass eStaticClass() {
		return MKAOSPackage.Literals.RESPONSABILITY_LINK;
	}
	...
	public EList<Requirement> getAssignAgentTo() {
		if (assignAgentTo == null) {
			assignAgentTo = new EObjectResolvingEList<Requirement>(Requirement.class, this, MKAOSPackage.RESPONSABILITY_LINK__ASSIGN_AGENT_TO);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MKAOSPackage.RESPONSABILITY_LINK__ASSIGN_AGENT_TO:
