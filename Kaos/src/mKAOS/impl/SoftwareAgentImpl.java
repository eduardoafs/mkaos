 ...
 * </p>
 * <ul>
 *   <li>{@link mKAOS.impl.SoftwareAgentImpl#getResponsibleFor <em>Responsible For</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SoftwareAgentImpl extends AgentImpl implements SoftwareAgent {
	...
	protected EClass eStaticClass() {
		return MKAOSPackage.Literals.SOFTWARE_AGENT;
	}
	...
	public EList<Requirement> getResponsibleFor() {
		if (responsibleFor == null) {
			responsibleFor = new EObjectResolvingEList<Requirement>(Requirement.class, this, MKAOSPackage.SOFTWARE_AGENT__RESPONSIBLE_FOR);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MKAOSPackage.SOFTWARE_AGENT__RESPONSIBLE_FOR:
